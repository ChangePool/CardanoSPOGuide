...
For an illustration, see the <a href={useBaseUrl('/GettingStarted#topology')}>Cardano Network Topology</a> diagram.
...
<!-- February 22, 2026 - In Cardano Node 10.6.2 and above, legacy topology functionality--including the EnableP2P key in the node configuration file--is removed. -->
<!--
...
If you configure two or more relays in your stake pool configuration, then consider [Implementing Peer Sharing](/PeerSharing) to help improve network security.
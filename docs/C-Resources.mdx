---
title: "Appendix C: Cardano Resources"
sidebar_label: "Appendix C: Cardano Resources"
slug: /AppendixC
hide_title: false
...
*Appendix C* aims to present a well-rounded, unbiased collection of general Cardano resources available online and useful for stake pool operators, listed alphabetically by name or topic, including an accurate description of content available at each resource.

[11 Blockchain Tenets: Towards a Blockchain Bill of Rights](https://www.iog.io/news/the-11-blockchain-tenets-towards-a-blockchain-bill-of-rights) describes general principles that are widely accepted by the Cardano community and reflect the basic rights of community members, as users and contributors to the ecosystem.
...
[AdaStat](https://adastat.net/) is a Cardano explorer that gives you all the Cardano blockchain details.
...
[Daedalus](https://daedaluswallet.io/) is an open-source, full-node wallet for ADA developed by [Input Output](https://www.iog.io/) and maintained by [Se7en Labs](https://se7enlabs.com/).
...
[Input Output](https://www.iog.io/) is a founding entity of Cardano, and one of the world’s pre-eminent blockchain research and engineering companies.

[Input Output Blog](https://www.iog.io/news) regularly publishes details related to current projects at [Input Output](https://www.iog.io/).
...
[Lace](https://www.lace.io/) is a light wallet platform for exploring Cardano and Web3, developed by [Input Output](https://www.iog.io/).

[Mithril Guide](https://mithril.network/doc/) provides a complete guide to the Mithril project, which allows you to restore the Cardano blockchain on your local computer using snapshots, more quickly than the time required to synchronize the full blockchain ledger from the network. <!-- Mithril is still in development. Use Mithril on Mainnet entirely at your own risk.
Source: https://github.com/input-output-hk/mithril -->
...
[pool.pm](https://pool.pm/) is a Cardano explorer featuring dynamic non-fungible token (NFT) visualizations, assisting NFT enthusiasts and creators to monitor and showcase their assets.
...
<a id="stakepoolcourse" />[Operate a Stake Pool](https://developers.cardano.org/docs/operators/) publishes guidelines and procedures for setting up a Cardano stake pool.

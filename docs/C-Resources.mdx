...
<a id="stakepoolcourse" />[Stake Pool Course](https://developers.cardano.org/docs/operate-a-stake-pool/) publishes guidelines and procedures for setting up a Cardano stake pool.

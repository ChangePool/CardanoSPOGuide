      ...
      <table class="box">
        <tbody>
          <tr>
            ...
            <td class="boxText"><p class="boxText">For more details as well as suggestions on reducing the number of missed checks to prepare a block, see the topic <a href="/ImprovingNodePerformance">Improving Cardano Node Performance</a>.</p></td>
          </tr>
        </tbody>
      </table>

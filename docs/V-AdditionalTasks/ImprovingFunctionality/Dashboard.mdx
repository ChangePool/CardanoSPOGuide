...
export function HTMLContent() {
  return (
    <div>
      ...
      <figure>
        <img src={useBaseUrl('img/PrometheusNetworkDiagram.png')} />
      ...
      <figure>
        <img src={useBaseUrl('img/GUIDashboardNetworkDiagram.png')} />
      ...
      <table class="box">
        <tbody>
          <tr>
            ...
            <td class="boxText"><p class="boxText">For details on using the Cardano Node Prometheus endpoint, see <a href={useBaseUrl('/MonitoringMetrics')}>Monitoring Metrics</a>. The following procedure assumes that Cardano Node Prometheus endpoints in your stake pool configuration listen on the default port 12798. If you change the port number, then update the procedure accordingly.</p></td>
          </tr>
        </tbody>
      </table>

      <p>To connect to the Prometheus and Grafana servers securely as an end user, consider <a href={useBaseUrl('/Hardening/SSH#Using-Port-Forwarding')}>Using Port Forwarding</a>.</p>
...
sudo systemctl status prometheus-node-exporter.service`}
        ...
        <li>On the computer where you installed Prometheus Node Exporter in step 6, in the firewall open ports 12798 and 9100 to incoming traffic. If you use UFW, then follow the commands to open a port in <a href={useBaseUrl('/Hardening/Firewall#Configuring-Uncomplicated-Firewall')}>Configuring Uncomplicated Firewall</a> updating the port numbers as needed.
          <table class="box">
            <tbody>
              <tr>
...
sudo systemctl status grafana-server.service`}
        ...
        <table class="box">
          <tbody>
            <tr>
              <td class="boxLabel"><p class="boxLabel">Note<br /><img src={useBaseUrl('img/BoxNote.png')} alt="Note" /></p></td>
              <td class="boxText"><p class="boxText">If you are <a href={useBaseUrl('/Hardening/SSH#Using-Port-Forwarding')}>Using Port Forwarding</a>, then adjust the URL accordingly.</p></td>
            </tr>
          </tbody>
        </table></li>
      ...
      <ol>
        <li>On the computer hosting the Grafana server, download the example <a href={useBaseUrl('txt/GrafanaDashboard.json')}>Grafana Dashboard</a> file.</li>
      ...
      <figure>
        <img src={useBaseUrl('img/GrafanaDashboard.jpg')} />
      ...
      <p>To explore some additional third-party Grafana dashboards available in the Cardano community, see <a href={useBaseUrl('/AppendixD')}>Appendix D: Community Projects</a>.</p>

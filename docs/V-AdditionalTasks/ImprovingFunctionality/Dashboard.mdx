  ...
  return (
    <div>
      ...
      <ul>
        ...
        <li><a href="https://github.com/prometheus/node_exporter" target="_blank">Prometheus Node Exporter</a> enables exporting system hardware and operating system metrics for a host computer using Prometheus. Additionally, enabling a textfile collector allows you to export any custom statistics that you may generate.</li>
...
scrape_configs:
  ...
  - job_name: 'stakepool'
    ...
    static_configs:
      ...
      <p class="pi">To configure Prometheus Node Exporter to use a textfile collector:</p>
...
sudo systemctl restart prometheus-node-exporter.service`}
      ...
      <p class="pi">To export custom statistics using the textfile collector:</p>

      <ol>
        <li></li>
      </ol>

      {/* <!-- After adding a new custom statistic to a textfile collector PROM file, refresh the browser tab displaying the Prometheus Web user interface to see the new statistic in query results. --> */}

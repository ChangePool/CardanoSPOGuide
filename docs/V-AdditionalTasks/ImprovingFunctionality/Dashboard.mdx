...
sudo systemctl status grafana-server.service`}
      ...
      <p class="pi">To create a graphical dashboard for monitoring a Cardano stake pool using Grafana:</p>
      ...
      <table class="box">
        <tbody>
          <tr>
            <td class="boxLabel"><p class="boxLabel">Important<br /><img src="img/BoxImportant.png" alt="Important" /></p></td>
            <td class="boxText"><p class="boxText">To create or troubleshoot a graphical dashboard using Grafana, test PromQL queries using the Prometheus Web user interface.</p></td>
          </tr>
        </tbody>
      </table>

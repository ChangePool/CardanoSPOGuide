...
scrape_configs:
  ...
  - job_name: 'stakepool'
    ...
    static_configs:
      ...
      <p>If a PromQL query does not filter targets and data satisfying the query are available from multiple targets, then query results include the data from each target.</p>

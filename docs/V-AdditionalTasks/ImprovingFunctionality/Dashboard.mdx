...
mv $\{textfileCollectorPath\}/exportMetrics.tmp $\{textfileCollectorPath\}/exportMetrics.prom`}
        ...
        <li>To verify that custom metrics you may generate export successfully, using a Web browser press <b>CTRL+F5</b> to perform a hard refresh of the Prometheus Web user interface, and then query the custom metrics.</li>
      </ol>

...
sudo systemctl restart prometheus-node-exporter.service`}
      ...
      <p class="pi">To export custom metrics using the textfile collector:</p>

      <ol>
        <li></li>
      </ol>

      {/* <!-- As sudo, create a text file in the /var/lib/prometheus/node-exporter/textfile-collector folder using the format <Name> <Value> and having a PROM file name extension. After adding a new custom metric to a textfile collector PROM file, refresh the browser tab displaying the Prometheus Web user interface to see the new metric in query results. --> */}

...
sudo apt-get upgrade -y`}
        ...
        <li>During the installation, when prompted:
          <ol>
            ...
            <li>To select the base channel, type <b>G</b></li>
            <li>To decline the pre-releases channel, type <b>N</b></li>
            <li>To decline the cross channel, type <b>N</b></li>
            <li>To decline the 3rd-party channel, type <b>N</b></li>
            ...
            <li>When prompted to enable better integration with GHCup, type <b>N</b></li>
          </ol>
        </li>

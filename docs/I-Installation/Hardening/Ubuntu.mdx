...
The *How to Set Up a Cardano Stake Pool* guide assumes that you run the Cardano Node software application on computers using a new [Ubuntu 26.04 LTS Desktop](https://releases.ubuntu.com/resolute/) installation.
...
1\. Follow the [Install Ubuntu Desktop](https://ubuntu.com/desktop/docs/en/latest/tutorial/install-ubuntu-desktop/) tutorial.
...
- Follow the [How to Configure a Static IP Address on Ubuntu 26.04 Desktop](https://linuxconfig.org/how-to-configure-a-static-ip-address-on-ubuntu-26-04-desktop) tutorial.

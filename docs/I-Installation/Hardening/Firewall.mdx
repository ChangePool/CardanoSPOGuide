...
You have now configured a basic firewall to help secure your stake pool. As you work through the *How to Set Up a Cardano Stake Pool* guide, periodically you may need to adjust UFW rules to allow additional applications that you may install on computers in your stake pool configuration to function. Always aim to minimize potential entry points that may be used to attack computers comprising your Cardano stake pool.

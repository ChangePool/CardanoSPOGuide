...
The `root` account is the superuser account having unlimited administrative privileges to manage your computer. In Ubuntu 26.04, the `root` account is enabled by default.

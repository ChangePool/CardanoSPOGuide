...
Cardano stake pools operating on Mainnet hold significant value. Therefore, you need to secure each computer hosting an instance of Cardano Node in your stake pool configuration.

## :robot: First Steps

* Installing Ubuntu [Server](https://ubuntu.com/tutorials/install-ubuntu-server) or [Desktop](https://ubuntu.com/tutorials/install-ubuntu-desktop)
* Installing [SSH server](https://www.simplified.guide/ubuntu/install-ssh-server)
* Setting Up an [SSH client or terminal window access](https://www.howtogeek.com/311287/how-to-connect-to-an-ssh-server-from-windows-macos-or-linux/)

...
- To [Configure Secure Shell](#configuring-secure-shell) connections:
    ...
    - [Change the Listening Port Number](#changing-the-listening-port-number)
...
By default, SSH Server listens on port 22. Changing the port where SSH Server listens helps to obscure the SSH Server.

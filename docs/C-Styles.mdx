    ...
    <div>
      ...
      <p>In the comprehensive sample text below, parentheses contain one of the following to help you use each style:</p>
        <ul class="bt">
          ...
          <li>Path to a file containing an HTML snippet, relative to the root folder of the Web site source files for the <i>How to Set Up a Cardano Stake Pool</i> guide</li>
        </ul>
      <h1>Heading 1 (h1)</h1>
      ...
      <p>To preserve whitespace in a code sample, assign a multiline string to a constant, and then reference the constant:</p>
      <pre>
      ...
      <table class="box">
        <tbody>
          <tr>
            <td width="125pt"><p class="boxLabel">Note</p></td>
            <td><p class="boxText">For more details on displaying code blocks preserving whitespace, see the source file for <i>Appendix C</i>, available at the relative path <code>/docs/C&#8209;Styles.mdx</code></p></td>
          </tr>
        </tbody>
      </table>

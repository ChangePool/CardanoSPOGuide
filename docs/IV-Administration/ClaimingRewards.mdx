...
export function HTMLContent() {
  ...
  return (
    <div>
      ...
      <ol>
        <li>Ensure that the stake address storing rewards to claim is <a href={useBaseUrl('/VoteDelegation')}>Delegating to a Representative</a>.</li>
        <li>Ensure that the destination payment address receiving staking rewards has a balance of at least ₳1 to pay the transaction fee.
          <table class="box">
            <tbody>
              <tr>

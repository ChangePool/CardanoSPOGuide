...
7\. Update scripts as needed on all computers in your stake pool configuration to use Cardano Tracer endpoints and metric names. For more details, see the topic [Monitoring Metrics](/MonitoringMetrics).

...
A new Cardano Node release may include changed or newly added configuration files. If a release changes existing configuration files or introduces new configuration files, then you need to download and implement the latest configuration files when upgrading a node.

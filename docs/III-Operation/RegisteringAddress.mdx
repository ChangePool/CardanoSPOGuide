...
export function HTMLContent() {
  ...
  var calculateFeeRegisteringAddress = calculateFee.replace("{{tx-out-count}}", "1");
  calculateFeeRegisteringAddress = calculateFeeRegisteringAddress.replace("{{witness-count}}", "2");
      ...
      <ol>
        ...
        <li>To build a draft transaction for calculating the minimum transaction fee, type:
          <pre>
            ...
            $&#123;tx_in&#125; \<br />
            &nbsp;&nbsp;--tx-out $(cat $NODE_HOME/payment.addr)+$(( $&#123;total_balance&#125; - 200000 - $&#123;stakeAddressDeposit&#125; )) \<br />
        ...
        <li>To calculate the current minimum fee for the transaction in Lovelace, type:
          <CodeBlock>
        ...
        <li>To calculate change from the transaction, type:
          <pre>
            txOut=$(($&#123;total_balance&#125;-$&#123;fee&#125;-$&#123;stakeAddressDeposit&#125;))<br />
            echo Change: $&#123;txOut&#125;
          </pre>
          <table class="box">
            <tbody>

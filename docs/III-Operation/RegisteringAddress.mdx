  ...
  return (
    <div>
      ...
      <ol>
        ...
        <li>To build a temporary transaction used to calculate the transaction fee, type:
          <pre>
        ...
        <li>To calculate change from the transaction, type:
          ...
          <table class="box">
            <tbody>
              <tr>
                <td class="boxLabel"><p class="boxLabel">Note<br /><img src="img/BoxNote.png" alt="Note" /></p></td>
                <td class="boxText"><p class="boxText">If change from the transaction is a negative number, then funds are insufficient. If funds are insufficient, then the transaction fails.</p></td>
              </tr>
            </tbody>
          </table>
        </li>

  ...
  return (
    <div>
      ...
      <ol>
        ...
        <li>Using a wallet of your choice, send funds that you want to pledge to the address that displays in step 1
          <table class="box">
            <tbody>
              <tr>
                <td class="boxLabel"><p class="boxLabel">Challenge<br /><img src="img/BoxChallenge.png" alt="Challenge" /></p></td>
                <td class="boxText"><p class="boxText">If needed, create a transaction <a href="/SendingFunds">Sending Funds</a> to the new payment address.</p></td>
              </tr>
            </tbody>
          </table>
        </li>

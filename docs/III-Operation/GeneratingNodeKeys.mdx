  ...
  return (
    <div>
      ...
      <ul>
        ...
        <li><b>Registration Certificate</b>—<code>pool.cert</code></li>
          ...
          <table class="box">
            <tbody>
              <tr>
                ...
                <td class="boxText"><p class="boxText">To ensure that your Cardano stake pool operating on Mainnet remains secure, do NOT use or store the cold keys for your stake pool on a computer that connects to a network or the Internet.</p></td>
              </tr>
            </tbody>
          </table>
        </li>
        <li>Back up the cold keys that you generated in step 1 using a secure and comprehensive backup strategy.
          <table class="box">
            <tbody>
              <tr>
                <td class="boxLabel"><p class="boxLabel">Important<br /><img src="img/BoxImportant.png" alt="Important" /></p></td>
      ...
      <ol>
        ...
        <li>Using removable media, copy the <code>$NODE_HOME/kes.vkey</code> from the computer designated as the block-producing node in your stake pool configuration to <code>$HOME/kes.vkey</code> on the air-gapped, offline computer.</li>
        <li>On the air-gapped, offline computer, using a terminal window type the following command where <code>&lt;currentKesPeriod&gt;</code> is the value that you calculated in step 2:
          <pre>
            ...
            &nbsp;&nbsp;--kes-verification-key-file $HOME/kes.vkey \<br />
            &nbsp;&nbsp;--cold-signing-key-file $HOME/cold-keys/node.skey \<br />
            &nbsp;&nbsp;--operational-certificate-issue-counter $HOME/cold-keys/node.counter \<br />
            &nbsp;&nbsp;--kes-period &lt;currentKesPeriod&gt; \<br />
            &nbsp;&nbsp;--out-file $HOME/node.cert
          </pre>
        </li>
        <li>Using removable media, copy the <code>$HOME/node.cert</code> file to <code>$NODE_HOME/node.cert</code> on the computer designated as the block-producing node in your stake pool configuration.</li>
      </ol>
      ...
      <ol>
        ...
        <li>Using removable media, copy the <code>$NODE_HOME/vrf.vkey</code> file to <code>$HOME/vrf.vkey</code> on the air-gapped, offline computer.</li>
      </ol>
      ...
      <ol>
        ...
        <li>To confirm that the Cardano Node instance is operating as a block producer, verify that the <code>cardano.node.metrics.forging_enabled</code> EKG metric has the value <code>1</code></li>
      </ol>

...
export function HTMLContent() {
  return (
    <div>
      ...
      <figure>
        <img src={useBaseUrl('img/BlockProductionProcess.png')} />
...
nodeView.sh`}
      ...
      <table class="box">
        <tbody>
          <tr>
            <td class="boxLabel"><p class="boxLabel">Note<br /><img src={useBaseUrl('img/BoxNote.png')} alt="Note" /></p></td>
            <td class="boxText"><p class="boxText">For more details on using and customizing the <code>nodeView.sh</code> script, see the topic <a href={useBaseUrl('/MonitoringMetrics')}>Monitoring Metrics</a>.</p></td>
          </tr>
        </tbody>
      </table>
      ...
      <p>For some additional third-party scripts and other software available in the Cardano community providing examples of how to calculate slot leadership for a stake pool that you operate, see <a href={useBaseUrl('/AppendixD')}>Appendix D: Community Projects</a>.</p>

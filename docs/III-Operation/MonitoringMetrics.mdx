  ...
  12798
      ...
      <table class="box">
        <tbody>
          <tr>
            <td class="boxLabel"><p class="boxLabel">Note<br /><img src="img/BoxNote.png" alt="Note" /></p></td>
            <td class="boxText"><p class="boxText">The script includes functionality to display data related to blocks that the stake pool you operate is scheduled to produce, if data are available on the block-producing node. After <a href="/RegisteringPool">Registering Your Stake Pool</a>, the topic <a href="/CalculatingSlotLeadership">Calculating Slot Leadership</a> explains how to query the slot leadership schedule. For now, you can ignore the functionality in the script related to querying slot leadership.</p></td>
          </tr>
        </tbody>
      </table>

  ...
  return (
    <div>
      ...
      <ul>
        ...
        <li><b>cardano.node.metrics.slotInEpoch.int</b>—The slot number of the tip of the local copy of the Cardano blockchain ledger since the beginning of the tip epoch. A slot occurs every second. Therefore, each epoch is comprised of 432,000 slots.
          <table class="box">
            <tbody>
              <tr>

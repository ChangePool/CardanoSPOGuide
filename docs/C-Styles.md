...
export function HTMLContent() {
  return (
    <div>
      ...
      <h1>Style Guide</h1>
      <p>In the comprehensive sample text below, parentheses contain one of the following to help you use each style:</p>
        <ul class="bt">
          <li>HTML tag (may be nested)</li>
          <li>CSS <code>.class</code> selector</li>
          <li>Relative path to a file containing an HTML snippet</li>
        </ul>
      <h1>Heading 1 (h1)</h1>
      ...
      <p>Paragraph Text (p)—You can create <code>inline code</code> (code) or code blocks (code.block):</p>
      <code class="block">function Code()<br />
        &#123;<br />
        &nbsp;&nbsp;&nbsp;&nbsp;Sample Code;<br />
        &nbsp;&nbsp;&nbsp;&nbsp;Sample Code;<br />
        &nbsp;&nbsp;&nbsp;&nbsp;Sample Code;<br />
      ...
      <figure>
        ...
        <figcaption>Figure 1 Caption (figure figcaption)</figcaption>
      </figure>
      <p class="pi">Procedure Introduction (p.pi):</p>
      <ol>
        <li>List Item (li)</li>
